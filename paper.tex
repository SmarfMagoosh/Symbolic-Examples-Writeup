...
\begin{enumerate}
    ...
    \item $\inference
        [StarInit]
        {\envhasnt{\path}{\lab} & \envget{\env}{\lab} = n & \inpwp{\lab}{0} r*_{\lab} \matches xs, \out}
        {\inp r*_{\lab} \matches xs, \out}$
    \item $\inference
        [Star]
        {\envget{\path}{\lab} < n & \envget{\env}{\lab} = n & \inp r \matches xs, \out & \inpwp{\lab}{\envget{\path}{\lab} + 1} r*_{\lab} \matches ys}
        {\inp r*_{\lab} \matches xs ++ ys}$
    \item $\inference
        [StarEnd]
        {\envget{\env}{\lab} \leq 0 \lor \envget{\path}{\lab} \geq \envget{\env}{\lab}}
        {\inp r*_{\lab} \matches \nil, \out}$

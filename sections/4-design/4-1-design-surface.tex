...
has type $[[\type]]$) is rejected with a compile-time \bill{I think? Evan, is it compile time?} \evan{correct, see Quoter.hs line 67 on commit "fixed names in QuasiQuoter"} error message.

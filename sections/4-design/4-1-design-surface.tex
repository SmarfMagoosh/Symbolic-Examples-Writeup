...
\mypara{Features}
Many features of the surface language resemble the core language--
for instance labels, labeled unions, labeled kleene closures, and labeled bindings.
...
where $\surface_1 \translateOne \surface_2$ denotes
that the expression $\surface_1$ is translated to the surface language expression $\surface_2$. 
...
Other rules
simply recurse over sub-expressions,
\ThrCons is an example of such a rule.

...
a constraint argument may contain a variable that was not bound
...
as this will be handled when we actually need the variable \lab.
...
we do apply generation \gens to all the arguments $args$,

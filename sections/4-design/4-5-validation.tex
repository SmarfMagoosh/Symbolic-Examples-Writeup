...
\bill{Evan, change the above sentence, put that example tyou showed me here}
...
\bill{Evan, \ValidateAssignment seems wrong as is, because shouln't be generating a random value?
But I don't understand enough about how dependency map is working to fix.}

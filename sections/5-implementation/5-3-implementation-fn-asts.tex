...
Then it applies the NestedList rules to get the final computed type of \hs{Int -> [Int] -> [Int]}.
...
\input{sections/figures/fntype.tex}
\input{sections/figures/astslist.tex}
